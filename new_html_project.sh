...
cd "$folder_name"
vim "$program_name.html"

echo "--------------------------------------------------------------------------------------------------------------------------------------------"
echo "Congratulations! You have Git, Vim editor, and your project folder set up. You can start writing your program in '$program_name.html'. All done!"
